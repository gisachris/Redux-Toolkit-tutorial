...
# 📖 The Redux-Toolkit-tutorial <a name="about-project"></a>


**The Redux-Toolkit-tutorial** is justa tutorial repo i created to learn Redux.
...
there is no project presentaion
...
```sh
  cd my-folder
  git clone https://github.com/gisachris/Redux-Toolkit-tutorial.git
```
